...
class RouterProvider implements ServiceProviderInterface
{
    ...
    public function register(DiInterface $di): void
    {
        ...
        $di->setShared(DispatcherInterface::class, function() use(&$di) {
            $dispatcher = new class extends Dispatcher {

                #[\Override]
                public function callActionMethod($handler, string $actionMethod, array $params = [])
                {
                    $signature = new \ReflectionMethod($handler, $actionMethod);
                    $injected = [];
                    foreach($signature->getParameters() as $parameter) {
                        $injected[] = $this->getDI()->get((string) $parameter->getType());
                    }
                    $params = array_merge($injected, $params);

                    parent::callActionMethod($handler, $actionMethod, $params); // TODO: Change the autogenerated stub
                }
            };
